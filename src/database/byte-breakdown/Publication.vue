	...
	<App>
		<Card>
			...
			<div>
				...
				person. Let us dive into the details of how the AI really works.
			</div>
			<div>
				...
				accurately than using just a few images.
			</div>
			<div>
				<img
				...
				expressions of the source face while having the appearance of the target face.
			</div>
			<div>
				...
				deepfake images. After training is done, only the generator is used to create fake images.
			</div>
			<div>
				<img
					class="c-publication-image"
